...
bus = [
	...
	3	1	0	0	0	0	2	1.0307077	-12.276384	345	1	1.06	0.94;
	4	1	0	0	0	0	1	1.00446	-12.626734	345	1	1.06	0.94;
	5	1	0	0	0	0	1	1.0060063	-11.192339	345	1	1.06	0.94;
	6	1	0	0	0	0	1	1.0082256	-10.40833	345	1	1.06	0.94;
	7	1	0	0	0	0	1	0.99839728	-12.755626	345	1	1.06	0.94;
	8	1	0	0	0	0	1	0.99787232	-13.335844	345	1	1.06	0.94;
	...
	12	1	0	0	0	0	1	1.000815	-8.9988236	345	1	1.06	0.94;
	13	1	0	0	0	0	1	1.014923	-8.9299272	345	1	1.06	0.94;
	14	1	0	0	0	0	1	1.012319	-10.715295	345	1	1.06	0.94;
	15	1	1000	100	0	0	3	1.0161854	-11.345399	345	1	1.06	0.94;
	16	1	1000	100	0	0	3	1.0325203	-10.033348	345	1	1.06	0.94;
	17	1	0	0	0	0	2	1.0342365	-11.116436	345	1	1.06	0.94;
	18	1	1000	100	0	0	2	1.0315726	-11.986168	345	1	1.06	0.94;
	19	1	0	0	0	0	3	1.0501068	-5.4100729	345	1	1.06	0.94;
	20	1	0	0	0	0	3	0.99101054	-6.8211783	345	1	1.06	0.94;
	21	1	1000	100	0	0	3	1.0323192	-7.6287461	345	1	1.06	0.94;
	22	1	0	0	0	0	3	1.0501427	-3.1831199	345	1	1.06	0.94;
	23	1	0	0	0	0	3	1.0451451	-3.3812763	345	1	1.06	0.94;
	24	1	1000	100	0	0	3	1.038001	-9.9137585	345	1	1.06	0.94;
	25	1	0	0	0	0	2	1.0576827	-8.3692354	345	1	1.06	0.94;
	26	1	1000	100	0	0	2	1.0525613	-9.4387696	345	1	1.06	0.94;
	27	1	1000	100	0	0	2	1.0383449	-11.362152	345	1	1.06	0.94;
	28	1	1000	100	0	0	3	1.0503737	-5.9283592	345	1	1.06	0.94;
	29	1	0	0	0	0	3	1.0501149	-3.1698741	345	1	1.06	0.94;
	30	2	0	0	0	0	2	1.0499	-7.3704746	345	1	1.06	0.94;
	31	3	0	0	0	0	1	0.982	0	345	1	1.06	0.94;
	...
	39	2	0	0	0	0	1	1.03	-14.535256	345	1	1.06	0.94;
...
%     2    100     0    5000     -400    1.0     100     1       1000 	 0;
% %     3    800     0    4000     -400    1.03     100 	1       1000     0;
% %     4    650     0    2400     -400    1.01     100 	1       1000     0;
%     ];
gen = [
	30	800	161.762	400	140	1.0499	100	1	1040	0;
	31	800	221.574	300	-100	0.982	100	1	646	0;
	32	800	206.965	300	150	0.9841	100	1	725	0;
	33	800	108.293	250	0	0.9972	100	1	652	0;
	34	800	166.688	167	0	1.0123	100	1	508	0;
	35	800	210.661	300	-100	1.0494	100	1	687	0;
	36	800	100.165	240	0	1.0636	100	1	580	0;
	37	800	-1.36945	250	0	1.0275	100	1	564	0;
	38	800	21.7327	300	-150	1.0265	100	1	865	0;
	39	800	78.4674	300	-100	1.03	100	1	1100	0;
    ];
...
branch(:,3:4) = branch(:,3:4)*10;
% branch(:,3)=0*branch(:,3);
branch(:,5) = branch(:,5)/10*4;
% branch(:,3) = branch(:,3)*0;
return;
