function [resultsac,resultsdc,converged] = powerflowcaculate...
    (mpcac,mpcdc,SynMach_in_gidx,GFM_in_gidx,GFL_in_gidx)
...
resultsac.gen{:,'Gen_idx'}=Gen_idx;
resultsac.gen{:,'GWType'}=GWType;
...
resultsac.gen{cellstr(string(GFM_in_gidx)),'Gen_idx'}=[1:size(GFM_in_gidx,2)].';
resultsac.gen{cellstr(string(GFM_in_gidx)),'GWType'}=string('GFM');

resultsac.gen{cellstr(string(GFL_in_gidx)),'Gen_idx'}=[1:size(GFL_in_gidx,2)].';
resultsac.gen{cellstr(string(GFL_in_gidx)),'GWType'}=string('GFL');
