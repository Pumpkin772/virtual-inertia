    ...
    elseif (floor(AppType/10) == 1)              % Grid-following inverter
        ...
        elseif AppType==13
             switch SwitchFlag
                ...
                case 4; ParaCell{row(i)}.R      = UserValue;
                case 5; ParaCell{row(i)}.f_v_dc = UserValue;
                case 6; ParaCell{row(i)}.kp_pll  = UserValue;
                case 7; ParaCell{row(i)}.kp_dq = UserValue;
                case 8; ParaCell{row(i)}.ki_pll = UserValue;
                case 9; ParaCell{row(i)}.ki_dq = UserValue;
                case 10; ParaCell{row(i)}.t_v_filter = UserValue;
                otherwise
                    error(['Error: parameter overflow, bus ' num2str(AppBus) 'type ' num2str(AppType) '.']);
             end
        elseif AppType==14
            switch SwitchFlag
                ...
                case 9; ParaCell{row(i)}.ki_dq = UserValue;
                case 10; ParaCell{row(i)}.t_v_filter = UserValue;
                case 11; ParaCell{row(i)}.kp_p = UserValue;
                case 12; ParaCell{row(i)}.ki_p = UserValue;
                otherwise
                    error(['Error: parameter overflow, bus ' num2str(AppBus) 'type ' num2str(AppType) '.']);
            end
        elseif AppType==15
            switch SwitchFlag
                ...
                case 11; ParaCell{row(i)}.kp_p = UserValue;
                case 12; ParaCell{row(i)}.ki_p = UserValue;
                case 13; ParaCell{row(i)}.kinertia = UserValue;
                case 14; ParaCell{row(i)}.kdroop = UserValue;    
                otherwise
                    error(['Error: parameter overflow, bus ' num2str(AppBus) 'type ' num2str(AppType) '.']);
            end
        end
    elseif floor(AppType/10) == 2                % Grid-forming inverter
        ...
        elseif AppType==21
            switch SwitchFlag
                ...
                case 9;  ParaCell{row(i)}.fvdq    = UserValue;
                case 10; ParaCell{row(i)}.fidq    = UserValue;
                case 11; ParaCell{row(i)}.J       = UserValue;
                otherwise
                    error(['Error: parameter overflow, bus ' num2str(AppBus) 'type ' num2str(AppType) '.']);
            end
        elseif AppType==22
             switch SwitchFlag
                ...
                case 10; ParaCell{row(i)}.fidq    = UserValue;
                case 11; ParaCell{row(i)}.J       = UserValue;
                case 12; ParaCell{row(i)}.SB       = UserValue;    
                otherwise
                    error(['Error: parameter overflow, bus ' num2str(AppBus) 'type ' num2str(AppType) '.']);
            end
        end
